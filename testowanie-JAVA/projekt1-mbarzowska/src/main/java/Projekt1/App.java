...
public class App {
    ...
    public static void main( String[] args ) throws IOException, ParseException {
        BoardCafe myCafe = new BoardCafe();
            ...
            if (!bc.UserIsLoggedIn(user)) {
                ...
                switch (input) {
                    case ("0"):
                        ...
                        break;
                    case ("1"):
                        if (user.UsersBookedGamesList.isEmpty()) {
                            System.out.println("You don't have any games booked yet!");
                        } else {
                            System.out.println("Your games list:");
                            user.ShowBookedGamesList();
                        }
                        break;
                    case ("2"):
                        System.out.println("Available games:"); bc.ShowGamesList();
                        ...
                        try {
                            if (bc.GameExists(gameName)) {
                                ...
                                System.out.println("Your games list:"); user.ShowBookedGamesList();
                            } else {
